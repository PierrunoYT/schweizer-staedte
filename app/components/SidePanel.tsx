    ...
    <div className="w-80 bg-gradient-to-b from-gray-50 to-white shadow-xl border-r border-gray-200/50 backdrop-blur-sm">
      <div className="p-6 border-b border-gray-200/50">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900">Swiss Cities</h2>
            <p className="text-sm text-gray-600">Explore Switzerland</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-6">
        ...
        <div className="space-y-4">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <h4 className="text-sm font-medium text-blue-900 mb-2">Quick Search Tips</h4>
